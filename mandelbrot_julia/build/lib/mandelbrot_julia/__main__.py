...
def main():
    ...
    parser.add_argument('--max-iter', metavar='max_iter', type=int, default=200,
                        help="Nombre maximum d'itération pour le calcul de la suite (par défaut: 200)")
    parser.add_argument('--parametre_c', '-c', metavar='c', type=complex, default=0.5,
                        help="Paramètre c dans le calcul de la suite (par défaut: 0.5)") 
